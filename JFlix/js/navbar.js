...
// Ensure premium-banner.js is loaded globally on all pages (except those in /NOADS/ via its own logic)
if (!document.querySelector('script[src*="premium-banner.js"]')) {
  const bannerScript = document.createElement('script');
  bannerScript.src = 'js/premium-banner.js?v=1.1';
